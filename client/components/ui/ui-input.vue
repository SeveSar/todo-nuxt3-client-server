    ...
    <div class="w-full" :class="customClass">
        ...
        <div class="relative">
            <input
                ...
                class="w-full border rounded-md shadow-sm py-2 pl-3 pr-10 text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" :class="[
