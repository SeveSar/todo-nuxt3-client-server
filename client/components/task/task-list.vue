<template>
    <UiCard v-bind="attrs" class="grow flex flex-col ">
        ...
        <TaskListControls :search="filters.search" :active-tab="filters.filter" :is-show-all="filters.isShowAll"
        ...
        <UiPagination v-if="data?.data.length" class="mt-auto" :current-page="filters.page"
